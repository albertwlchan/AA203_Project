...
class Pendrogone_test(gym.Env):
    ...
    def __init__(self):
        ...
        # limits
        self.limits = Pendrogone_test.LIMITS
    ...
    def render(self, mode='human'):
        ...
        t1_xy = Pendrogone_test.transform(self.pos_quad,
                                     self.state[2],
                                     np.array([self.arm_length, 0]))
        t2_xy = Pendrogone_test.transform(self.pos_quad,
                                     self.state[2],
                                     np.array([-self.arm_length, 0]))
        ...
        if self.viewer is None:
            ...
            self.viewer.set_bounds(-Pendrogone_test.LIMITS[0], Pendrogone_test.LIMITS[0],
                                   -Pendrogone_test.LIMITS[1], Pendrogone_test.LIMITS[1])
